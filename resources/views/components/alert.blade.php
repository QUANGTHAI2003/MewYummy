@if (Session::has('success'))
    <div id="toast-success triggerElement"
         class="toast-hide toast-message mb-4 flex max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
         role="alert">
        <div
...
@if (Session::has('error'))
    <div id="toast-warning"
         class="toast fixed right-5 top-20 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400"
         role="alert" style="z-index: 999999999999999999">
        <div
