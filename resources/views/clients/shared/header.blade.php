        ...
        <div class="row align-items-center">
            <div class="col-3 col-lg-2">
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ asset('storage/images/logo.webp') }}" loading="lazy" class="img-fluid logo d-none
              d-lg-block"/>
                    <img src="{{ asset('storage/images/logo_mobi.webp') }}" loading="lazy" class="img-fluid logo d-block d-lg-none"/>
                </a>
            </div>
                ...
                <div class="d-lg-flex align-items-center position-static ps-menu">
                    <div class="search__block me-3 me-xl-5">
                        <form action="#" class="search__block-form" spellcheck="false" autocomplete="off">
                            <input type="text" class="search__block-input form-control" role="search" spellcheck="false" autocomplete="off" placeholder="Tìm kiếm sản phẩm ..."/>
                  ...
                  mx-lg-0">
                      ...
                      text-white"> Sản phẩm ( <span>0</span>)
                                    </div>
                          ...
                          result-item border-bottom align-item js-link">
                            ...
                            align-items-center justify-content-center">
                                                    <img alt="Ba Chỉ Bò Mỹ , Short Plate (500gr)" src="{{ asset('storage/images/products/pro6.webp') }}" class="result-item_image img-fluid js-img">
                                                </div>
                      ...
                      text-white"> Tin tức ( <span>0</span>)
                                    </div>
                                    <div class="searchResult_articles"></div>
                                    <div class="d-block text-left h6 searchResult__text
                      text-white"> Trang nội dung ( <span>0</span>)
                                    </div>
                  ...
                  me-3">
                                ...
                                <ul class="pop__login sub__menu">
                                    <li class="pop__login-list">
                                        <a href="{{ route('account.index') }}" class="pop__login-link d-block
                        fw-bold">Tài khoản</a>
                                    </li>
                                    <li class="pop__login-list">
                                        <a href="{{ route('login') }}" class="pop__login-link d-block
                        fw-bold">Đăng nhập</a>
                                    </li>
                                    <li class="pop__login-list">
                                        <a href="{{ route('register') }}" class="pop__login-link d-block
                        fw-bold">Đăng ký</a>
                                    </li>
                                </ul>
                            </div>
...
<nav class="navbar me-lg-auto">
    <div class="container">
        ...
        d-lg-block">
            ...
            <li class="main__menu pt-lg-2 pb-lg-2 {{ request()->is('product') ? 'active' : ''}} pb-1 dropdown">
    ...
    <div class="container">
        <ul id="menu-mobi" class="d-lg-none">
            <li class="main__menu pt-lg-2 pb-lg-2">
                <a class="ps-lg-3 ps-2 active" href="{{ route('home') }}">
                    <i class="fa-solid fa-house icon"></i>
                    <span>Trang chủ</span>
                </a>
            </li>
            <li class="main__menu pt-lg-2 pb-lg-2 menu">
                <button class="ps-lg-3" data-bs-toggle="offcanvas" data-bs-target="#menuSidebar" aria-controls="menuSidebar">
    ...
    <section class="offcanvas offcanvas-start mx-3" data-bs-scroll="true" tabindex="-1" id="menuSidebar" aria-labelledby="offcanvasWithBothOptionsLabel">
