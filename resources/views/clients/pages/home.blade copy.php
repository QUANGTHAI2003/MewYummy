        ...
        <div id="sliderBanner" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('storage/images/clients/slide-img1.webp') }}" class="d-block w-100" alt="Slide 1">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('storage/images/clients/slide-img2.webp') }}" class="d-block w-100" alt="Slide 2">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container productInfoSwiper overflow-hidden">
        <div class="product__info-wrapper swiper-wrapper">
            <div class="product__info-item swiper-slide mx-sm-5 pr-sm-5 mx-md-3">
                <img src="{{ asset('storage/images/clients/img_poli_1.webp') }}" loading="lazy"/>
                <div class="media-body">Sản phẩm an toàn</div>
            </div>
            <div class="product__info-item swiper-slide">
                <img src="{{ asset('storage/images/clients/img_poli_2.webp') }}" loading="lazy"/>
                <div class="media-body">Cam kết chất lượng</div>
            </div>
            <div class="product__info-item swiper-slide">
                <img src="{{ asset('storage/images/clients/img_poli_3.webp') }}" loading="lazy"/>
                <div class="media-body">Dịch vụ vượt trội</div>
            </div>
            <div class="product__info-item swiper-slide">
                <img src="{{ asset('storage/images/clients/img_poli_4.webp') }}" loading="lazy"/>
                <div class="media-body">Giao hàng nhanh chóng</div>
            </div>
        </div>
    </div>
    <div class="wave__slide bg-white">
        <img src="{{ asset('storage/images/clients/wave_down.svg') }}" loading="lazy"/>
    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="box__cate row">
                                ...
                                <div class="img__cate col-5 col-sm-6">
                                    <a href="#">
                                        <img class="lazy" src="{{ asset('storage/images/clients/cate1.webp') }}" loading="lazy"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide swiper-slide-next">
                            <div class="box__cate row">
                                ...
                                <div class="img__cate col-5 col-sm-6">
                                    <a href="#">
                                        <img class="lazy" src="{{ asset('storage/images/clients/cate2.webp') }}" loading="lazy"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="box__cate row">
                                ...
                                <div class="img__cate col-5 col-sm-6">
                                    <a href="#">
                                        <img class="lazy" src="{{ asset('storage/images/clients/cate3.webp') }}" loading="lazy"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="box__cate row">
                                ...
                                <div class="img__cate col-5 col-sm-6">
                                    <a href="#">
                                        <img class="lazy" src="{{ asset('storage/images/clients/cate4.webp') }}" loading="lazy"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="box__cate row">
                                ...
                                <div class="img__cate col-5 col-sm-6">
                                    <a href="#">
                                        <img class="lazy" src="{{ asset('storage/images/clients/cate5.webp') }}" loading="lazy"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="box__cate row">
                                ...
                                <div class="img__cate col-5 col-sm-6">
                                    <a href="#">
                                        <img class="lazy" src="{{ asset('storage/images/clients/cate6.webp') }}" loading="lazy"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <h2 class="title text-center text-lg-left">
                        <a class="position-relative" href="#">
                            <img src="{{ asset('storage/images/clients/flash.gif') }}" loading="lazy"/> FLASH SALE hàng tuần
                        </a>
                    </h2>
                </div>
                                        ...
                                        <div class="item-info">
                                            <div class="clearfix">
                                                <div class="sold-module modal-open">
                                                    <img src="{{ asset('storage/images/clients/hot-sale.webp') }}" loading="lazy" decoding="" class="position-absolute"/>
...
<section class="banner mt-4">
    <div class="container">
        <div class="image">
            <img class="rounded overflow-hidden" src="{{ asset('storage/images/clients/banner.webp') }}" loading="lazy"/>
        </div>
    </div>
</section><!-- Product Meat -->
        ...
        <div class="row align-items-center">
            <div class="col-xl-3 col-lg-4 col-md-5 col-xs-12 mb-3 mb-md-0">
                <a href="#" class="imageBanner">
                    <img src="{{ asset('storage/images/clients/banner-meat.webp') }}" loading="lazy"/>
                </a>
            </div>
...
<section class="product__seafood">
    <div class="container">
        ...
        <div class="row align-items-center flex-sm-column-reverse flex-md-row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-5 col-xs-12 mb-3 mb-md-0">
                <a href="#" class="imageBanner">
                    <img src="{{ asset('storage/images/clients/banner-seafood.webp') }}" loading="lazy"/>
                </a>
            </div>
        </div>
    </div>
</section><!-- Product Vegatable -->
<section class="product__vegatable">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-xl-3 col-lg-4 col-md-5 col-xs-12 mb-3 mb-md-0">
                <a href="#" class="imageBanner">
                    <img src="{{ asset('storage/images/clients/banner-vegatable.webp') }}" loading="lazy"/>
                </a>
            </div>
            <div class="col-xl-9 col-lg-8 col-md-7 col-xs-12">
                <div class="b_product">
            ...
            <div class="video-container position-relative overflow-hidden">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      ...
                      open_video">
                                    <div class="ratio3by2">
                                        <img src="{{ asset('storage/images/clients/video.webp') }}" loading="lazy" class="d-block img
                    ...
                    <div class="swiper-slide swiper-slide-next">
                      ...
                      open_video">
                                    <div class="ratio3by2">
                                        <img src="{{ asset('storage/images/clients/video2.webp') }}" loading="lazy" class="d-block
                    ...
                    <div class="swiper-slide">
                      ...
                      open_video">
                                    <div class="ratio3by2">
                                        <img src="{{ asset('storage/images/clients/video3.webp') }}" loading="lazy" class="d-block
                          img img-cover position-absolute lazy"/>
                    ...
                    <div class="swiper-slide">
                      ...
                      open_video">
                                    <div class="ratio3by2">
                                        <img src="{{ asset('storage/images/clients/video4.webp') }}" loading="lazy" class="d-block
                          img img-cover position-absolute lazy"/>
                ...
                <div class="swiper-wrapper">
                    ...
                    bor-10">
                        ...
                        ratio3by2 has-edge aspect">
                                        <img src="{{ asset('storage/images/clients/blog1.webp') }}" loading="lazy" class="lazy d-block img img-cover position-absolute
                    ...
                    bor-10">
                                <a class="effect-ming">
                                    <div class="position-relative w-100 m-0 be_opa modal-open
                        ratio3by2 has-edge aspect">
                                        <img src="{{ asset('storage/images/clients/blog2.webp') }}" loading="lazy" class="lazy d-block img img-cover position-absolute
                ...
                15px;">
                    ...
                    bor-10">
                                <a href="#" class="effect-ming">
                                    <div class="position-relative w-100 m-0 be_opa modal-open
                        ratio3by2 has-edge aspect">
                                        <img src="{{ asset('storage/images/clients/blog3.webp') }}" loading="lazy" class="lazy d-block img img-cover position-absolute
                ...
                15px;">
                    ...
                    bor-10">
                                <a href="#" class="effect-ming">
                                    <div class="position-relative w-100 m-0 be_opa modal-open
                        ratio3by2 has-edge aspect">
                                        <img src="{{ asset('storage/images/clients/blog4.webp') }}" loading="lazy" class="lazy d-block img img-cover position-absolute
