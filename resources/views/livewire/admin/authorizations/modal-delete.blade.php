<div wire:ignore.self id="deleteUserModal" tabindex="-1"
    ...
    <div class="relative max-h-full max-w-md">
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Bạn có chắc xóa user này không</h3>
                <button wire:click.prevent="destroyUser" data-modal-hide="deleteUserModal" type="button"
