...
@section('content')
    <x-page-title currentPage="Quản lý biến thể" pageTitle="Danh sách biến thể"/>
    <h3 class="text-gray-700 text-3xl font-medium">Danh sách biến thể</h3>
    ...
    <livewire:admin.products.product-attribute/>
@endsection
