                    ...
                    <div class="bg-white px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="SottoCategoria" class="block text-sm font-medium text-gray-700">Category
                                    Name</label>
                            ...
                            {{-- <div class="col-span-3 sm:col-span-2">
                                          ...
                                          <div class="mt-4">
                                              <input type="radio" class="form-radio" name="is_active" id="published" value="1" {{ old('is_active') == 1 ? 'checked' : '' }}>
                                              <span class="ml-2" style="margin-left:6px;margin-right:10px;">Show</span>

                                              <input type="radio" class="form-radio" name="is_active" id="is_active" value="0" {{ old('is_active') == 0 ? 'checked' : '' }}>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="SottoCategoria" class="block text-sm font-medium text-gray-700">Slug</label>
                        ...
                        <x-forms.feature-button back="{{ route('admin.categories') }}"/>
                    </div>
                </div>
            </form>
