                                              ...
                                              <tr>
                                                <td
                                                  ...
                                                  <a target="_blank" rel="noopener noreferrer"
                                                    href="{{ route("resetPassword", ['token' => $user->token]) }}"
                                                    class="button button-primary verify-email"
                              ...
                              <tr>
                                <td
                                  ...
                                  <p
                                    ...
                                    Nếu có vấn đề gì khi nhấn "Đổi mật khẩu" thì copy và paste đường dẫn bên dưới vào trình duyệt
                                    <span class="break-all"
                                      ...
                                      <a target="_blank" rel="noopener noreferrer"
                                        href="{{ route("resetPassword", ['token' => $user->token]) }}"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">{{ route("resetPassword", ['token' => $user->token]) }}</a>
                                    </span>
                                  </p>
                                </td>
                              </tr>
                      ...
                      <tr>
                        <td class="content-cell" align="center"
                          ...
                          <p
                            ...
                            © 2023 Mew Yummy. All rights reserved.</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
